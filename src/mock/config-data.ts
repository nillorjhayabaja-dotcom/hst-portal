...
export const POSITIONS: Position[] = [
  ...
  },
  {
    ...
    reportsToPositionId: "pos-president",
    reportsToTitle: "President",
    level: 2,
    approvalAuthority: true,
  ...
  },
  {
    ...
    defaultRole: "manager",
    reportsToPositionId: "pos-prod-mgr",
    reportsToTitle: "Production Manager",
    level: 4,
    approvalAuthority: true,
    active: true,
  },
  ...
  },
  {
    ...
    departmentName: "Human Resources",
    defaultRole: "hr",
    reportsToPositionId: "pos-hr-mgr",
  ...
  },
  {
    ...
    departmentName: "General Administration",
    defaultRole: "gad",
    reportsToPositionId: "pos-gad-mgr",
    reportsToTitle: "GAD Manager",
    level: 4,
    approvalAuthority: false,
    active: true,
  },
  ...
  },
  {
    ...
    reportsToPositionId: "pos-supervisor",
    reportsToTitle: "Production Supervisor",
    level: 6,
    approvalAuthority: false,
    active: true,
  },
  {
    ...
    departmentName: "Quality Assurance",
    defaultRole: "employee",
    reportsToPositionId: "pos-qa-mgr",
    reportsToTitle: "QA Manager",
    level: 5,
    approvalAuthority: false,
    active: true,
  },
  {
    ...
    departmentName: "Warehouse & Logistics",
    defaultRole: "employee",
    reportsToPositionId: "pos-wh-mgr",
    reportsToTitle: "Warehouse Manager",
    level: 5,
    approvalAuthority: false,
    active: true,
  },
  {
    ...
    departmentName: "Maintenance",
    defaultRole: "supervisor",
    reportsToPositionId: "pos-maint-mgr",
    reportsToTitle: "Maintenance Manager",
    level: 5,
    approvalAuthority: false,
    active: true,
  },
...
export const EMPLOYEES_EXTENDED: EmployeeExtended[] = [
  {
    ...
    status: "Active",
    role: "employee",
    positionId: "pos-operator",
    positionTitle: "Production Operator",
    supervisorId: "EMP-1043",
    supervisorName: "Jomar Reyes",
    joined: "2021-03-14",
  },
  {
    id: "EMP-1043",
    ...
    supervisorId: "EMP-1044",
    supervisorName: "Grace Lim",
    joined: "2018-07-01",
  },
  {
    id: "EMP-1044",
    ...
    status: "Active",
    role: "manager",
    positionId: "pos-prod-mgr",
    positionTitle: "Production Manager",
    supervisorId: "EMP-1000",
    supervisorName: "Robert Tan",
    joined: "2015-01-20",
  },
  {
    id: "EMP-1050",
    ...
    supervisorId: "EMP-1051",
    supervisorName: "Catherine Reyes",
    joined: "2019-09-11",
  },
  {
    id: "EMP-1061",
    ...
    status: "Active",
    role: "gad",
    positionId: "pos-gad-officer",
    positionTitle: "GAD Officer",
    supervisorId: "EMP-1062",
    supervisorName: "Luis Mercado",
    joined: "2017-05-03",
  },
  {
    id: "EMP-1077",
    ...
    status: "Active",
    role: "security",
    positionId: "pos-security",
    positionTitle: "Security Officer",
    supervisorId: "EMP-1061",
    supervisorName: "Andres Villa",
    joined: "2020-02-18",
  },
  {
    id: "EMP-1088",
    ...
    status: "Active",
    role: "supervisor",
    positionId: "pos-qa-mgr",
    positionTitle: "QA Manager",
    supervisorId: "EMP-1044",
    supervisorName: "Grace Lim",
    joined: "2016-11-29",
  },
  ...
  },
  {
    ...
    status: "Active",
    role: "supervisor",
    positionId: "pos-maint-lead",
    positionTitle: "Maintenance Lead",
    supervisorId: "EMP-1100",
    supervisorName: "Dante Villanueva",
    joined: "2019-04-22",
  },
  {
    id: "EMP-1105",
  ...
  },
  {
    ...
    supervisorId: "EMP-0999",
    supervisorName: "Daniel Cruz",
    joined: "2010-03-01",
  },
  {
    id: "EMP-0999",
  ...
  },
  {
    id: "EMP-1062",
    name: "Luis Mercado",
    email: "luis.mercado@hst-corp.com",
    title: "GAD Manager",
    departmentId: "dept-gad",
    departmentName: "General Administration",
    status: "Active",
    role: "gad",
    positionId: "pos-gad-mgr",
    positionTitle: "GAD Manager",
    supervisorId: "EMP-1000",
    supervisorName: "Robert Tan",
    joined: "2016-09-20",
  },
...
export const PERMISSION_MATRIX: ConfigurablePermission[] = [
  {
    roleId: "super_admin",
    moduleId: "gate-pass",
    actions: ["create", "view", "edit", "delete", "approve", "export", "full"],
    scope: "all",
  },
  ...
  { roleId: "super_admin", moduleId: "dashboard", actions: ["full"], scope: "all" },
  {
    roleId: "admin",
    moduleId: "gate-pass",
    actions: ["create", "view", "edit", "approve", "export"],
    scope: "all",
  },
  {
    roleId: "admin",
  ...
  { roleId: "admin", moduleId: "workflows", actions: ["view", "edit"], scope: "all" },
  {
    roleId: "admin",
    moduleId: "employees",
    actions: ["create", "view", "edit", "export"],
    scope: "all",
  },
...
export const NOTIFICATION_RULES: NotificationRule[] = [
  {
    ...
    templateBody:
      "A new gate pass request {{title}} ({{control_number}}) has been submitted by {{requester}}.",
    active: true,
  },
  {
    id: "nr-2",
    ...
    templateBody:
      "Your gate pass {{title}} ({{control_number}}) has been approved by {{approver}}.",
    active: true,
  },
  {
    id: "nr-3",
  ...
  },
  {
    ...
    templateBody:
      "A purchase request {{title}} ({{control_number}}) worth {{amount}} needs your review.",
    active: true,
  },
  {
    id: "nr-6",
  ...
  },
  {
    ...
    templateBody:
      "Gate pass {{control_number}} has been escalated due to timeout at {{step}} step.",
    active: true,
  },
];
...
export const DOCUMENT_FORMATS: DocumentNumberFormat[] = [
  ...
  },
  {
    ...
    includeDepartment: false,
    sequenceLength: 4,
    format: "{PREFIX}{SEP}{YEAR}{SEP}{MONTH}{SEP}{SEQ}",
    nextSequence: 501,
    active: true,
  },
  {
...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    id: "wt-manufacturing",
    name: "Standard Manufacturing Workflow",
    description: "Employee → Supervisor → Manager → GAD → Security",
    category: "Manufacturing",
    defaultSteps: ["employee", "supervisor", "manager", "gad", "security"],
    active: true,
  },
  {
    id: "wt-hr",
    name: "Standard HR Workflow",
    description: "Employee → Supervisor → Manager → HR",
    category: "Human Resources",
    defaultSteps: ["employee", "supervisor", "manager", "hr"],
    active: true,
  },
  {
    id: "wt-procurement",
    name: "Standard Procurement Workflow",
    description: "Employee → Manager → Purchasing → Finance",
    category: "Procurement",
    defaultSteps: ["employee", "manager", "admin", "admin"],
    active: true,
  },
  {
    id: "wt-simple",
    name: "Simple 2-Step Workflow",
    description: "Employee → Manager",
    category: "General",
    defaultSteps: ["employee", "manager"],
    active: true,
  },
  {
    id: "wt-executive",
    name: "Executive Approval Workflow",
    description: "Employee → Manager → Executive",
    category: "General",
    defaultSteps: ["employee", "manager", "executive"],
    active: true,
  },
];
...
export const HOLIDAYS: Holiday[] = [
  ...
  },
  {
    ...
    type: "company_event",
    recurring: false,
    description: "HST Technologies Foundation Anniversary",
  },
  {
    id: "hol-14",
    ...
    type: "company_event",
    recurring: false,
    description: "Company-wide Christmas celebration",
  },
];
...
export const BUSINESS_RULES: BusinessRule[] = [
  {
    id: "br-1",
    name: "High-value Purchase → Finance",
    description: "Purchases over ₱250,000 require Finance approval",
    moduleId: "purchase-request",
    priority: 1,
  ...
  {
    id: "br-2",
    name: "Company Vehicle → Vehicle Coordinator",
    description: "If transportation is company vehicle, add vehicle coordinator step",
    moduleId: "gate-pass",
    priority: 1,
    conditions: [{ field: "transportation", operator: "eq", value: "company_vehicle" }],
    actions: [
      { type: "insert_step", target: "workflow", value: "gad" },
      { type: "notify", target: "role", value: "gad" },
    ],
    active: true,
  },
  {
    id: "br-3",
    name: "Urgent Requests → Priority",
    description: "Mark requests as urgent if amount exceeds ₱500,000",
    moduleId: "purchase-request",
    priority: 2,
  ...
  {
    id: "br-4",
    name: "Weekend Gate Pass → GAD Required",
    description: "Weekend gate passes require GAD pre-approval",
    moduleId: "gate-pass",
    priority: 1,
    conditions: [{ field: "is_weekend", operator: "eq", value: "true" }],
    actions: [
      { type: "insert_step", target: "workflow", value: "gad_approval" },
      { type: "notify", target: "role", value: "gad" },
    ],
    active: true,
  },
  {
    id: "br-5",
    name: "Long Leave (5+ days) → HR Approval",
    description: "Leaves longer than 5 days require HR approval",
    moduleId: "leave",
    priority: 1,
    conditions: [{ field: "days", operator: "gte", value: 5 }],
    actions: [
      { type: "insert_step", target: "workflow", value: "hr_approval" },
      { type: "notify", target: "role", value: "hr" },
    ],
    active: true,
  },
  {
    id: "br-6",
    name: "Sick Leave with Doctor's Note",
    description: "Sick leave requests require medical certificate attachment",
    moduleId: "leave",
    priority: 2,
...
export const SYSTEM_SETTINGS: SystemSetting[] = [
  ...
  {
    key: "notifications.escalation_check_interval",
    value: "60",
    category: "notifications",
    description: "Escalation check interval in minutes",
    type: "number",
  },
  {
    key: "approvals.auto_approve_threshold",
    value: "10000",
    category: "approvals",
    description: "Auto-approve amount threshold",
    type: "number",
  },
  {
    key: "approvals.require_comment_on_reject",
    value: "true",
    category: "approvals",
...
export const ROLE_CONFIGS: RoleConfig[] = [
  ...
  },
  {
    ...
    shortName: "Executive",
    level: 3,
    description: "Company dashboard, executive KPIs, analytics and approval monitoring.",
    active: true,
  },
  {
    id: "manager",
