...
export function PRModule() {
  ...
  const handleApprove = (note?: string) => { toast.success("PR approved"); setShowApprove(false); setSelectedRequest(null); };
  const handleReject = (note?: string) => { toast.error("PR rejected"); setShowReject(false); setSelectedRequest(null); };
  const handleReturn = (note?: string) => { toast.warning("PR returned"); setShowReturn(false); setSelectedRequest(null); };
