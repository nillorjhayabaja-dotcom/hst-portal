...
export function LeaveModule() {
  ...
  const handleApprove = (note?: string) => { toast.success("Leave approved"); setShowApprove(false); setSelectedRequest(null); };
  const handleReject = (note?: string) => { toast.error("Leave rejected"); setShowReject(false); setSelectedRequest(null); };
  const handleReturn = (note?: string) => { toast.warning("Leave returned"); setShowReturn(false); setSelectedRequest(null); };
